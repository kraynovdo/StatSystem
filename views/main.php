...
<head>
    ...
    <?}?>
    <link rel="stylesheet" type="text/css" href="//<?=$HOST?>/themes/main.css?129"/>
    <?if ($theme) {?>
        <link rel="stylesheet" type="text/css" href="//<?=$HOST?>/themes/<?=$theme?>/<?=$theme?>.css?9"/>
    <?}?>
    <?if ($IS_MOBILE) {?>
        <link rel="stylesheet" type="text/css" href="//<?=$HOST?>/themes/main_mobile_s.css?41"/>
    <?}?>
...
<?if (file_exists($_SERVER['DOCUMENT_ROOT'] . $CONSTPath  . '/views/' . $controller . '/' . $controller . '.js')) {?>
    <script type="text/javascript" src="//<?=$HOST?>/views/<?=$controller?>/<?=$controller?>.js?45"></script>
<?}?>
