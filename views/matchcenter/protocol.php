...
<div class="fafr-minWidth fafr-maxWidth">
    <?if (count($answer['protocol'])) { $protocol = $answer['protocol']?>

    <div class="main-fieldWrapper">
        <? if (($_SESSION['userType'] == 3) || ($_SESSION['userType'] == 4)) {?>
            <a class="fafr-link" href="/?r=protocol/edit&ret=matchcenter&match=<?=$_GET['match']?>&comp=<?=$_GET['comp']?>">Редактировать</a>
        <?}?>
        <a class="fafr-link" href="/?r=protocol/print&match=<?=$_GET['match']?>&comp=<?=$_GET['comp']?>">Печать</a>
    </div>
    ...
    <table class="protocol-view">
        ...
        <tr>
            <td><span class="protocol-view_label"><?=$answer['maininfo']['t1name']?> - цвет формы</span></td>
            <td><span><?=$protocol['color1']?></span></td>
        </tr>
        <tr>
            <td><span class="protocol-view_label"><?=$answer['maininfo']['t2name']?> - цвет формы</span></td>
        ...
        <tr>
            <td><span class="protocol-view_label"><?=$answer['maininfo']['t1name']?> - форма игроков</span></td>
            <td><span><?=$points[$protocol['form1']]?></span></td>
        </tr>
        <tr>
            <td><span class="protocol-view_label"><?=$answer['maininfo']['t2name']?> - форма игроков</span></td>
            <td><span><?=$points[$protocol['form2']]?></span></td>
        </tr>
        <tr>
            <td><span class="protocol-view_label"><?=$answer['maininfo']['t1name']?> - поведение игроков</span></td>
            <td><span><?=$points[$protocol['player1']]?></span></td>
        </tr>
        <tr>
            <td><span class="protocol-view_label"><?=$answer['maininfo']['t2name']?> - поведение игроков</span></td>
            <td><span><?=$points[$protocol['player2']]?></span></td>
        </tr>
        <tr>
            <td><span class="protocol-view_label"><?=$answer['maininfo']['t1name']?> - поведение тренеров</span></td>
            <td><span><?=$points[$protocol['coach1']]?></span></td>
        </tr>
        <tr>
            <td><span class="protocol-view_label"><?=$answer['maininfo']['t2name']?> - поведение тренеров</span></td>
